...
import { postLike } from '../../actions/likesActions';
            ...
            return (
                <div className="item" key={post.id}>
                    ...
                    <div className="content">
                        ...
                        <button onClick={this.props.postLike(post.id)}>
...
export default connect(mapStateToProps, { fetchPosts, postLike })(PostLists);
