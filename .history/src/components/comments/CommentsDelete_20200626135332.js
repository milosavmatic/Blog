...
const mapStateToProps = (state, ownProps) => {
    console.log(Object.values(state.comments.comment));
    return {
        deleteComments: state.comments.deleteComments,
        comments: state.comments.comment[ownProps.match.params.id],
    };
};

export default connect(mapStateToProps, { deleteComments, fetchComments })(
    CommentsDelete
);
