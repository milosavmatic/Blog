...
import { POST_COMMENTS, FETCH_COMMENTS, EDIT_COMMENTS, DELETE_COMMENTS } from './types';
...
export deleteComments = (id) => async (dispatch) => {
await posts.delete(`/comments?${id}`)
dispatch({ type: DELETE_COMMENTS, payload: response.data})
}
